...
tabela = pd.read_excel(r"D:\Downloads\Vendas - Dez.xlsx")  # localizar o arquivo no sistema e ler/ r’ indica que o texto é uma raw string. Ou seja, sem caracteres especiais.
...
#7 Preencher o email
pyautogui.press("tab")
texto_email =  f'''Bom dia Sr/Sra fulano de tal, estou encaminhando um relatório sobre as vendas
